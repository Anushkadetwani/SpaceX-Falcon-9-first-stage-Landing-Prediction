...
def get_pie_chart(entered_site):
    ...
    if entered_site=='All':
        ...
        ls=site_df.groupby('class').sum().reset_index()
        fig2=px.pie(ls,values='Flight Number',
                    names= 'class',
...
def get_scatter(entered_site,payload_mass):
    if entered_site=='All':
        ...
        fig4=px.scatter(site_df,x='Payload Mass (kg)',y='class',color="Booster Version Category")
        return fig4
